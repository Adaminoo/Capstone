...
const checkUserRegistration = async (user_id, course_id) => {
    const checkQuery = 'SELECT COUNT(*) FROM user_courses WHERE user_id = $1 AND course_id = $2';
...
const registerForCourse = async (req, res) => {
    ...
    try {
        ...
        const capacityQuery = 'SELECT maximum_capacity, COUNT(*) AS current_registration FROM user_courses WHERE course_id = $1 GROUP BY course_id';
        ...
        const insertQuery = 'INSERT INTO user_courses (user_id, course_id) VALUES ($1, $2)';
...
const unregisterFromCourse = async (req, res) => {
    ...
    try {
        const deleteQuery = 'DELETE FROM user_courses WHERE user_id = $1 AND course_id = $2';
